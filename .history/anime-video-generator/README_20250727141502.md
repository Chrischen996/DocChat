...
A desktop application that generates anime-style videos using ByteDance's Doubao Seedance 1.0 model via Fal.ai's API. Built with Next.js and designed to be packaged with Electron for cross-platform desktop deployment.

## Features

- **Multiple AI Models**: Choose between Fal.ai Seedance and ByteDance Doubao models
...
- A ByteDance Doubao API key (get one at [doubao.bytedance.com](https://doubao.bytedance.com)) - Optional
...
3. Enter your API key in the "Fal.ai API Key" field
4. Click "Validate Key" to ensure it's working
...
2. Enter a descriptive prompt (e.g., "An anime character with blue hair running through a magical forest")
3. Choose your desired resolution, duration, and aspect ratio
4. Click "Generate Video"
5. Wait for the generation to complete (typically 30-60 seconds)

### Image-to-Video Generation

1. Select "Image to Video" mode
2. Upload an image (JPG, PNG, WEBP, GIF, or AVIF)
3. Enter a prompt describing how you want the image animated
4. Choose your desired resolution and duration
...
Monitor your usage on the Fal.ai dashboard to manage costs.
