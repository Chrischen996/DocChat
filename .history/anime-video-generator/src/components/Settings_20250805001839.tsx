...
const Settings: React.FC<SettingsProps> = ({ isOpen, onClose }) => {
  ...
  const resolutionOptions = [
    { value: '480p', label: t('defaults.resolution.480p') || '480p (Lite)' },
    { value: '720p', label: t('defaults.resolution.720p') || '720p (Lite)' },
    { value: '1080p', label: t('defaults.resolution.1080p') || '1080p (Pro)' },
  ];

  const durationOptions = [
    { value: '5', label: t('defaults.duration.5s') || '5 seconds' },
    { value: '10', label: t('defaults.duration.10s') || '10 seconds' },
  ];

  const aspectRatioOptions = [
    { value: '16:9', label: t('defaults.aspectRatio.16:9') || '16:9 (Landscape)' },
    { value: '9:16', label: t('defaults.aspectRatio.9:16') || '9:16 (Portrait)' },
    { value: '1:1', label: t('defaults.aspectRatio.1:1') || '1:1 (Square)' },
  ];

  const modelOptions = [
    { value: 'fal-ai', label: t('defaults.model.fal') || 'Fal.ai Seedance' },
    { value: 'doubao', label: t('defaults.model.doubao') || 'ByteDance Doubao' },
  ];
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={t('title')} size="lg">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900">{t('apiKeys.title')}</h3>
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    ...
                    {' '}and{' '}
                    <a
                      href="https://doubao.bytedance.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="underline hover:text-blue-900"
                    >
          ...
          <div className="space-y-2">
            <Input
              label={t('apiKeys.falai.label')}
              type="password"
              value={apiKey}
              onChange={(e) => setApiKey(e.target.value)}
              placeholder={t('apiKeys.falai.placeholder')}
              helperText={t('apiKeys.falai.helperText')}
            />
          ...
          <div className="space-y-2">
            <Input
              label={t('apiKeys.doubao.label')}
              type="password"
              value={doubaoApiKey}
              onChange={(e) => setDoubaoApiKey(e.target.value)}
              placeholder={t('apiKeys.doubao.placeholder')}
              helperText={t('apiKeys.doubao.helperText')}
            />
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900">{t('defaults.title')}</h3>
