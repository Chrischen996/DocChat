...
const VideoGenerator: React.FC = () => {
  ...
  const aspectRatioOptions = [
    { value: '16:9', label: t('aspectRatio.16:9') },
    { value: '9:16', label: t('aspectRatio.9:16') },
    { value: '1:1', label: t('aspectRatio.1:1') },
  ];

  const modelOptions = [
    { value: 'fal-ai', label: t('model.fal') },
    { value: 'doubao', label: t('model.doubao') },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-gray-500">
          Choose between different AI models for video generation. Pricing and quality may vary.
        </p>
      </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800">
                {t('warnings.apiKeyRequired.title')}
              </h3>
              <div className="mt-2 text-sm text-yellow-700">
                <p>{t('warnings.apiKeyRequired.message')}</p>
              </div>
            </div>
          </div>
        </div>
