...
const VideoGenerator: React.FC = () => {
  ...
  const resolutionOptions = [
    { value: '480p', label: '480p（轻量版 ~￥1.3）' },
    { value: '720p', label: '720p（轻量版 ~￥1.3）' },
    { value: '1080p', label: '1080p（专业版 ~￥5.3）' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <Textarea
        ...
        rows={4}
        helperText={`已输入${prompt.length}/500 字符`}
        maxLength={500}
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>请在设置中配置您的 Fal.ai API Key 以生成视频。</p>
              </div>
            </div>
          </div>
        </div>
